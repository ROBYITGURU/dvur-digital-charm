...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Modern web for Malíkovský Dvůr offers luxury accommodations and experiences in Czech countryside." },
      { property: "og:description", content: "Modern web for Malíkovský Dvůr offers luxury accommodations and experiences in Czech countryside." },
      { name: "twitter:description", content: "Modern web for Malíkovský Dvůr offers luxury accommodations and experiences in Czech countryside." },
